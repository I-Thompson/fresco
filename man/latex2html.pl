...
BEGIN {
  ...
  if($ENV{'LATEX2HTMLDIR'}) {
    ...
    $ENV{'LATEX2HTMLDIR'} = $LATEX2HTMLDIR = '/sw/share/lib/latex2html';
  }

  if($ENV{'LATEX2HTMLPLATDIR'}) {
    $LATEX2HTMLPLATDIR = $ENV{'LATEX2HTMLPLATDIR'};
  } else {
    $LATEX2HTMLPLATDIR = '/sw/lib/latex2html'||$LATEX2HTMLDIR;
...
if ($opt{test_mode}) {
    ...
    $TEXEXPAND = "$PERL /Volumes/Fink/sw/src/fink.build/latex2html-2002-2-1-3/latex2html-2002-2-1${dd}texexpand";
    $PSTOIMG   = "$PERL /Volumes/Fink/sw/src/fink.build/latex2html-2002-2-1-3/latex2html-2002-2-1${dd}pstoimg";
    $ICONSERVER = L2hos->path2URL("/Volumes/Fink/sw/src/fink.build/latex2html-2002-2-1-3/latex2html-2002-2-1${dd}icons");
    $TEST_MODE  = 1;
    $RGBCOLORFILE = "/Volumes/Fink/sw/src/fink.build/latex2html-2002-2-1-3/latex2html-2002-2-1${dd}styles${dd}rgb.txt";
    $CRAYOLAFILE = "/Volumes/Fink/sw/src/fink.build/latex2html-2002-2-1-3/latex2html-2002-2-1${dd}styles${dd}crayola.txt";
}
if($DEBUG) {
...
#    " \\expandafter\\box\\next\\edef\\next{\\egroup\\def\\noexpand\\thiseqn{\\theequation}}\\next}%\n" .
    ...
    "  \\ifdim\\dimen0>1.0\\vsize\n" .  "   \\lthtmltypeout{%\n" .
    "*** image for \\lthtmlmathenv\\space is too tall at \\the\\dimen0, reducing to 1.0 vsize ***}%\n" .
    "   \\ht\\sizebox1.0\\vsize \\dp\\sizebox\\z\@ \\fi\n" .  "  \\lthtmltypeout{l2hSize %\n" .
...
global
goodbreak
hangafter # &ignore_numeric_argument
#hangindent # &ignore_numeric_argument
hbox
...
LATEX2HTMLDIR is F</sw/share/lib/latex2html>
